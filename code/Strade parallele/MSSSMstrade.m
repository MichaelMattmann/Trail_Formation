...
E = zeros(dm,dn); % entrance
    E1v = [1,30]; E(E1v(1),E1v(2))=1;
    E2v = [1,40]; E(E2v(1),E2v(2))=1;
...
U = zeros(dm,dn); % exits
    ...
    U3v = [70,30]; U(U3v(1),U3v(2))=1;
    U4v = [70,40]; U(U4v(1),U4v(2))=1;

T = 1; % durability of trail
I = 100; % intensity of footprints
v = 3; %velocity
...
vidObj = VideoWriter('paralleolo_pend1.avi');
open(vidObj);
